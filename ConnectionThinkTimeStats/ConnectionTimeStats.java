...
public class ConnectionTimeStats {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(ConnectionTimeStats.class);
    ...
    job.setMapperClass(ConnectionTimeStatsMapper.class);
    job.setReducerClass(ConnectionTimeStatsReducer.class);
