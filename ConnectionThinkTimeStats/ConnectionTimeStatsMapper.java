...
public class ConnectionTimeStatsMapper
    ...
    public void map(LongWritable key, Text value, Context context)
        ...
        if(tokens.length == 8) {
            ...
            if (direction == '>') {
                context.write(new Text(IPaddr1port), new DoubleWritable(thinkTime));
            } else {
                context.write(new Text(IPaddr2port), new DoubleWritable(thinkTime));
            }
        }
    }
}
