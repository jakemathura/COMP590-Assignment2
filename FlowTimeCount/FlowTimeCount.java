...
public class FlowTimeCount {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(FlowTimeCount.class);
    ...
    job.setMapperClass(FlowTimeCountMapper.class);
    job.setReducerClass(FlowTimeCountReducer.class);
