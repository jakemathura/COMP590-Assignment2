...
public class FlowAvgDur {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(FlowAvgDur.class);
		job.setJobName("Average Duration Between ADU Flow");
		...
		job.setMapperClass(FlowAvgDurMapper.class);
		job.setReducerClass(FlowAvgDurReducer.class);
